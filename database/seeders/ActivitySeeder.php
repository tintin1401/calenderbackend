...
class ActivitySeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Activity::create(['name'=>'I Project Advance 2,5%','description'=>'students in the course have to choose one of the following options for the completion of the group project.','image'=>'placeholder.jpg','date'=>'2024-10-09','hour'=>'17:00:00','labels_id'=>'2','courses_id'=>'8','categories_id'=>'2','status_activities_id'=>'2']);
        ...
        Activity::create(['name'=>'Lab 09','description'=>'Carefully watch the following video about the White Box Testing Process based on the ISTQB Foundation certification.','image'=>'placeholder.jpg','date'=>'2024-11-10','hour'=>'23:50:00','labels_id'=>'2','courses_id'=>'9','categories_id'=>'2','status_activities_id'=>'2']);
